...
export default (Vue) => {
  Vue.component('elCollapseHeader', ElCollapseHeader)
  Vue.component('elCollapseToggle', ElCollapseToggle)
  Vue.component('elStickySection', ElStickySection)
  ...
  Vue.component('elDelimiter', ElDelimiter)
  Vue.component('elCheckbox', ElCheckbox)
  Vue.component('elMenuItem', ElMenuItem)
  Vue.component('elDropdown', ElDropdown)
  Vue.component('ElTooltip', ElTooltip)
  Vue.component('elSection', ElSection)
